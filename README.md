...
| 团队成员 | 分工                                                 | 备注 |
| -------- | ---------------------------------------------------- | ---- |
| [dekrt](https://github.com/dekrt)   | 负责`Django web`框架的搭建、测试以及Web服务器的部署  | 队长 |
| [junj76](https://github.com/junj76)  | 负责数据预处理部分的编写、测试，前端页面的设计与实现 | 队员 |
| [lscLucienLee](https://github.com/lscLucienLee)   | 负责深度学习模型的搭建，测试，参数调整和数据可视化   | 队员 |
